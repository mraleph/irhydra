...
;(function() {
  ...
  function runInContext(context) {
    ...
    function isStringable(value) {
      return _.isString(value) || (_.has('toString', value) && _.isFunction(value.toString));
    }
    ...
    function clock() {
      ...
      clock = function(clone) {
        ...
        var bench = clone._original,
            ...
            decompilable = stringable || (support.decompilation && ('setup' in clone || 'teardown' in clone)),
            id = bench.id,
      ...
      function createCompiled(bench, decompilable, deferred, body) {
        ...
        return Function("return (function Benchmark$" + bench.name + "(" + 
