 ...
 * subgraph. Since subgraphs are nodes, the source or target end of an{@link Edge} may be a subgraph. For additional restrictions, refer to the
 ...
 * @since 2.1.2
 */
class CompoundDirectedGraph extends DirectedGraph {
  /**
   * For internal use only.
   */
  NodeList subgraphs = new NodeList();
  /**
   * For internal use only.
   */
  EdgeList containment = new EdgeList();
}
